...
export class CartController{
    static getCarts = async (req,res, next)=> {
        try {
            ...
            if(!carts){
                return CustomError.createError("Error", null, `No se encontraron carritos`, TIPOS_ERROR.NOT_FOUND);
            }
    ...
    static createCart = async (req,res, next)=>{
        try {
            ...
            if(!cart){
                return CustomError.createError("Error", null,"Error al crear carrito",TIPOS_ERROR.ARGUMENTOS_INVALIDOS)
            }
